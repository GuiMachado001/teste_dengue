document.querySelector('.container_btn_cadastrar_aluno').addEventListener('click', function () {
    ...
    try {
        ...
        if (!Array.isArray(escolas) || escolas.length === 0) {
            ...
            escolas.forEach(escola => {
                html += `
                    <a href="./listar_serie.php?id_escola=${escola.id_escola}" class="link_escola">
