...
<head>
    ...
    <!-- Css da pagina -->
     ...
     <link rel="stylesheet" href="../../../assets/css/cidade_css/editar_cidade.css">
    ...
    <!-- Js da pagina -->
     <script src="../../../assets/js/cidade_js/editar_cidade.js" defer></script>
</head>
<body>
    ...
    <section class="main">
      ...
      <!-- <div class="container_title_pagina">
        ...
        <form id="form_editar_cidade" class="form_editar_cidade">
            ...
            <div class="continer_inp_nome">
              ...
              <div class="input-container">
                ...
                <label for="input" class="label">Nome do cidade</label>
